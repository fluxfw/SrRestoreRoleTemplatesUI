...
```php
...
use srag\GeneratePluginInfosHelper\SrRestoreRoleTemplatesUI\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrRestoreRoleTemplatesUI\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrRestoreRoleTemplatesUI\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrRestoreRoleTemplatesUI\x\UpdateVersion; 
...
